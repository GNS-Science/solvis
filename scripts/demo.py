...
whitemans_0_polygon = Polygon(
    [(174.892, -41.3), (174.9, -41.345), (174.91, -41.33), (174.922, -41.32), (174.9360, -41.298)]
)

nap_hast_polygon = Polygon(
    [(176.7563, -39.4468), (177.0886, -39.4426), (177.1078, 39.7220), (176.7563, -39.7178), (176.7563, -39.4468)]
)

wlg_hex_polygon = Polygon(
    [
        (175.5780, -40.5472),
        (176.1053, -41.2902),
        (175.3418, -42.0656),
